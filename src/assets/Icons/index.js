...
export const MoonIcon = ({ className, width = '16px', height = '16px', viewBox = '0 0 16 16' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const PlusIcon = ({ className, width = '16px', height = '16px', viewBox = '0 0 16 16' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const UpIcon = ({ className, width = '16px', height = '16px', viewBox = '0 0 16 16' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const FireIcon = ({ className, width = '16px', height = '16px', viewBox = '0 0 16 16' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const MenuIcon = ({ className, width = '16px', height = '16px', viewBox = '0 0 16 16' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const RegularUseGroupIcon = ({
  className,
  width = '16px',
  height = '16px',
  viewBox = '0 0 16 16'
...
export const RegularCompassIcon = ({
  className,
  width = '16px',
  height = '16px',
  viewBox = '0 0 16 16'
  ...
  <svg
    ...
    <g fillRule="evenodd" clipRule="evenodd">
      ...
      <path
        fill="black"
        fillOpacity=".03"
        d="M2.402 12.2c1.187 2.497 3.357 4.727 5.348 6.55C9.55 20.399 11 21.5 12 21.5s2.41-1.093 4.25-2.75c2.98-2.684 6.25-6.25 6.25-10.25 0-.087-.002-.174-.005-.26C20.567 13.661 13.68 18.5 11.75 18.5c-1.437 0-6.14-2.687-9.348-6.3Z"></path>
    </g>
  </svg>
);
...
export const PlayIcon = ({ className, width = '16px', height = '16px', viewBox = '0 0 16 16' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const FlagIcon = ({ className, width = '16px', height = '16px', viewBox = '0 0 16 16' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const MuteIcon = ({ className, width = '16px', height = '16px', viewBox = '0 0 16 16' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const TagIcon = ({ className, width = '16px', height = '16px', viewBox = '0 0 16 16' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const LinkIcon = ({ className, width = '16px', height = '16px', viewBox = '0 0 16 16' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const LineIcon = ({ className, width = '16px', height = '16px', viewBox = '0 0 16 16' }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const DotIcon = () => {
  return <div className={cx('dot-icon')}></div>;
};
